...
--
-- Host: localhost
-- Generation Time: Apr 29, 2012 at 08:57 PM
...
SELECT t.id_persona id_persona
		FROM `TieneAccesoA` t
...
(6, 'Comedor', 4000),
(7, 'Laboratorio Nivel maximo', 8000);
...
CREATE TABLE IF NOT EXISTS `NivelDeSeguridad` (
  ...
  PRIMARY KEY (`nivel`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=8001 ;
...
(1, 'Jacinto', 'Lugones', 'jlugones', 'jacintolugones', 'Jerarquico'),
(2, 'Carlos', 'Tevez', 'ctevez', 'carlostevez', 'Profesional'),
(3, 'Gustavo ', 'Lopez', 'glopez', 'gustavolopez', 'NoProfesional'),
(4, 'Gonzalo', 'Gonzalez', 'ggonzalez', 'gonzalogonzales', 'Jerarquico'),
(5, 'Honorio', 'Urquiza', 'hurquiza', 'honoriourquiza', 'Profesional'),
(6, 'Hernan', 'Diaz', 'hdiaz', 'hernandiaz', 'NoProfesional'),
(7, 'Leonardo', 'Astrada', 'lastrada', 'leonardoastrada', 'Jerarquico'),
(8, 'Ramiro', 'Rodriguez', 'rrodriguez', 'ramirorodriguez', 'Profesional'),
(9, 'Andres', 'Nocioni', 'anocioni', 'andresnocioni', 'Profesional'),
(10, 'orlando', 'lastrani', 'olastrani', 'orlandolastrani', 'NoProfesional');
...
(2, 'Cientifico', 'PlantaPermanente'),
(5, 'Bacteriologo', 'PlantaPermanente'),
(8, 'Fisico Nuclear', 'Contratado'),
(9, 'Analista', 'Contratado');
...
ALTER TABLE `TieneAccesoA`
  ADD CONSTRAINT `TieneAccesoA_fk_hora_des` FOREIGN KEY (`hora_des`, `hora_has`) REFERENCES `Turno` (`hora_des`, `hora_has`),
